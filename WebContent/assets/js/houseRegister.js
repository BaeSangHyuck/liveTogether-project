...
$(".files").change(function(e) {
	...
	imgText += "<img id='board_file"+imgIndex+"Img' class='roomImg' src='${pageContext.request.contextPath}/images/파일첨부.png'>"
	imgText += "</label>"
	imgText += "</div>"
...
function cancelFile(fileName) {
	$("input#" + fileName).val("");
	$("img#" + fileName + "Img").attr("src", "${pageContext.request.contextPath}/images/파일첨부.png");
}
...
function roomAdd() {
	...
	text += "<img src='${pageContext.request.contextPath}/images/xMark.png' id='xMark'>"
	text += "</div>"
	text += "</td>"
	text += "</tr>"
	text += "<tr>"
