...
* 월 1회 공용공간 정기청소</pre>
			...
			<section id="three" class="tab">
				...
				<div>
					<div>
						<img
							src="https://woozoo.s3.amazonaws.com/uploads/house/plan_image/468/p-1644304365.jpg">
					</div>
				</div>
...
- 경우에 따라 반전세 적용이 불가한 하우스도 있으니 반드시 확인 부탁드립니다.</pre>
			...
			<section id="five" class="tab">
				...
				<div id="live">
					...
					<div>
						<p>
							입주 신청서를 제출하면 접수 확인 문자가 발송됩니다. 신규 지점을 신청하신 경우 본인이 선택한 우주 하우스 투어 하루
							전 날 확인 전화를 드리며,<br> 기존 지점을 신청하신 경우 입주 신청 후 2 일 내에 하우스 매니저가
							우주 하우스 투어 일정 조율을 위해 전화를 드립니다.<br> 우주 하우스 투어 일정이 확정되면 해당 일시에
					...
					<div>
						<p>선불 공과금이란 입주 계약기간 동안 일정 금액으로 정해진 예상 공과금을 선불로 납부하는 것을 말합니다.
							...
							써야 한다는 불편이 있습니다. 우주는 이 점을 개선하고자 우주인이 미리 지정된 고정 금액을 매달 선불로 납부하는
					...
					<div>
						<p>임대료와 동일하게 우주가 안내하는 대로 납부하시면 됩니다. 단, 실제로 거주했는지 여부와 관계 없이
					...
					<div>
						<p>계약사항에 위배되지 않는한 가치하우스는 입주자분들의 개인생활에 관여하지 않습니다. 다만, 같은 지점에
							거주하는우주인들은 입주 후 협의 하에 ‘주거규칙 가이드라인’을 만들어 원활한 셰어 라이프를 지켜나갑니다.</p>
					</div>
