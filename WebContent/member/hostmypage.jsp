...
<link rel="stylesheet" href="../assets/css/hostmypage.css" />
</head>
...
<c:set var="member" value="${member}"/>
   <article id="main">
      ...
      <div class="mypage">
            <div class="mypagetool">
                  <ul class="mypagebar">
                     <li class="num1">
                        <a href="${pageContext.request.contextPath}/member/HostMyPageLookOk.me">내 정보조회</a>
                     </li>
                     <li class="num2">
                        <a href="${pageContext.request.contextPath}/member/HostMyPageOk.me">내 정보수정</a>
                     </li>
                     <li class="num3">
               ...
               <div class="container">
                  <div id="change_info">
                     <div class="content-wrapper">
                        <div class="content">
                           <form class="info-form" action="${pageContext.request.contextPath}/member/HostMyPageUpdateOk.me" accept-charset="UTF-8"
                              method="post">
                              ...
                              <div class="column-wrapper profile">
                                 ...
                                 <div class="user_pro user">
                                    <input type="text" id="user_pro" maxlength="30" name="memberProfile" value="${member.getMemberProfile()}">
                                 </div>
                              </div>
   ...
   console.log($("#memberCode").val());
      ...
      $("#m-btn2").on("click",function(){
         location.href='${pageContext.request.contextPath}/member/MemberHostDelete.me';
