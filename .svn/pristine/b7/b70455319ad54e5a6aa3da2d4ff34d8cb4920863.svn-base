...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/noticeWrite.css" />
			...
			<div class="third-wrap">
				<form
					...
					<div class="files">
						<div class="file-wrap">
							<label for="board_file1" style="display: inline;"> <img
								id="board_file1Img" src="${pageContext.request.contextPath}/images/파일첨부.png" width="110px"
								height="110px" style="display: inline;">
							</label>
						...
						<div class="file-wrap">
							<label for="board_file2" style="display: inline;"> <img
								id="board_file2Img" src="${pageContext.request.contextPath}/images/파일첨부.png" width="110px"
								height="110px" style="display: inline;">
							</label>
						...
						<div class="file-wrap">
							<label for="board_file3" style="display: inline;"> <img
								id="board_file3Img" src="${pageContext.request.contextPath}/images/파일첨부.png" width="110px"
								height="110px" style="display: inline;">
							</label>
					...
					<div id="button-wrapper">
						<input type="button" id="buttonWrite" onclick="send();"
							value="글 쓰기"> <input type="button" id="buttonBack"
...
<script src="${pageContext.request.contextPath}/assets/js/noticeWrite.js"></script>
</html>